...
{
	// Read input image
    cv::Mat image= cv::imread("D://workspace//pictures//boldt.bmp",0);
	if (!image.data)
		return 0; 
    ...
    image= cv::imread("D://workspace//pictures//salted.bmp",0);
	if (!image.data)
		return 0; 
    ...
    image= cv::imread("D://workspace//pictures//boldt.jpg",0);
