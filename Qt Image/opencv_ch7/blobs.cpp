...
int main()
{
    ...
    cv::Mat image= cv::imread("D://workspace//pictures//binaryGroup.bmp",0);
	if (!image.data)
		return 0; 
    ...
    cv::Mat original= cv::imread("D://workspace//pictures//group.jpg");
    ...
    image= cv::imread("D://workspace//pictures//binaryGroup.bmp",0);
