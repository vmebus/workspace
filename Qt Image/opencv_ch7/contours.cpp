...
{
	// Read input image
    cv::Mat image= cv::imread("D://workspace//pictures//road.jpg",0);
	if (!image.data)
		return 0; 
	...
	// Display one line
    image= cv::imread("D://workspace//pictures//road.jpg",0);
	int n=0;
   ...
   // Display the detected line image
	...
	// Detect circles
    image= cv::imread("D://workspace//pictures//chariot.jpg",0);
