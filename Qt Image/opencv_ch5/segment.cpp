...
{
	// Read input image
    cv::Mat image= cv::imread("D://workspace//pictures//group.jpg");
	if (!image.data)
		return 0; 
	...
	// Get the binary map
	cv::Mat binary;
    binary= cv::imread("D://workspace//pictures//binary.bmp",0);
	...
	// Open another image
    image= cv::imread("D://workspace//pictures//tower.jpg");
	...
	// Open another image
    image= cv::imread("D://workspace//pictures//group.jpg");
