...
{
	// Read input image
    cv::Mat image= cv::imread("D://workspace//pictures//waves.jpg",0);
	if (!image.data)
		return 0; 
	...
	// Second test image
    cv::Mat image2= cv::imread("D://workspace//pictures//dog.jpg",0);
	cv::Mat result2;
	...
	// Load color image
	ColorHistogram hc;
    cv::Mat color= cv::imread("D://workspace//pictures//waves.jpg");
	...
	// Second color image
    cv::Mat color2= cv::imread("D://workspace//pictures//dog.jpg");
    ...
    color= cv::imread("D://workspace//pictures//waves.jpg");
	imageROI= color(cv::Rect(0,0,165,75)); // blue sky area
	...
	// Second color image
    color2= cv::imread("D://workspace//pictures//dog.jpg");
