...
{
	// Read input images
    cv::Mat image1= cv::imread("D://workspace//pictures//parliament1.bmp",0);
    cv::Mat image2= cv::imread("D://workspace//pictures//parliament2.bmp",0);
    ...
    cv::Ptr<cv::xfeatures2d::SURF> pfd = cv::xfeatures2d::SURF::create(10);
