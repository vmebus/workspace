...
{
	// Read input images
    cv::Mat image1= cv::imread("D://workspace//pictures//church01.jpg",0);
    cv::Mat image2= cv::imread("D://workspace//pictures//church03.jpg",0);
    ...
    surf->detectAndCompute(image1, cv::Mat(), keypoints_object, descriptors_object);
    surf->detectAndCompute(image2, cv::Mat(), keypoints_scene, descriptors_scene);
    ...
    cv::Ptr<cv::xfeatures2d::SurfDescriptorExtractor> surfDesc = cv::xfeatures2d::SurfDescriptorExtractor::create(100,4,3,false,false);
...
*/
	...
	// Read input images
    image1= cv::imread("D://workspace//pictures//church01.jpg",0);
    image2= cv::imread("D://workspace//pictures//church03.jpg",0);
