...
class RobustMatcher {
  ...
  public:
	  ...
	  RobustMatcher() : ratio(0.65f), refineF(true), confidence(0.99), distance(3.0) {	  
          ...
          cv::Ptr<cv::xfeatures2d::SURF> detector = cv::xfeatures2d::SURF::create(3000);
          cv::Ptr<cv::xfeatures2d::SurfDescriptorExtractor> extractor = cv::xfeatures2d::SurfDescriptorExtractor::create(100,4,3,false,false);
	  }

	  // Set the feature detector
      void setFeatureDetector(cv::Ptr<cv::xfeatures2d::SURF>& detect) {

		  detector= detect;
	  }

	  // Set descriptor extractor
      void setDescriptorExtractor(cv::Ptr<cv::xfeatures2d::SurfDescriptorExtractor>& desc) {
